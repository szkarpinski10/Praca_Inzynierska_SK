...
All the environments are registered in the `Praca_Inzynierska_SK` extension. They start
...
import Praca_Inzynierska_SK.tasks  # noqa: F401

# PLACEHOLDER: Extension template (do not remove this comment)
with contextlib.suppress(ImportError):
    import Praca_Inzynierska_SK.tasks_experimental  # noqa: F401
...
def _format_presets(preset_map: dict | None) -> str:
    ...
    Args:
        preset_map: Mapping of :class:`~Praca_Inzynierska_SK.utils.preset_target.PresetTarget`
    ...
    if preset_map is None:
        return "(unavailable)"
    from Praca_Inzynierska_SK.utils.preset_target import PresetTarget
...
def main():
    """Print all environments registered in `Praca_Inzynierska_SK` extension."""
    ...
    if args_cli.show_presets:
        from Praca_Inzynierska_SK.utils.preset_cli import enumerate_task_presets
